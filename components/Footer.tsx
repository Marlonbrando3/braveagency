    ...
    <div className="w-full bg-[#423e59]">
      <div className="lg:w-[1040px] lg:h-[240px] w-sreen h-[440px] lg:mx-auto flex flex-col items-center justify-center mx-[10px] ">
        <div className=" w-full">
          <div className="w-full h-4/6 whitespace-nowrap flex lg:flex-row flex-col text-thin items-start justify-center text-white">
            <div className="flex flex-col items-start mb-[20px] w-1/2">
              <p className="uppercase font-bold mb-2">Na skróty</p>
              <ul className="flex text-white justify-between">
                <Link href="/#aboutus">
                  <li className="list-item-style-footer text-xl">O nas</li>
                </Link>
                <Link href="/#mywork">
                  <li className="list-item-style-footer text-xl">Portfolio</li>
                </Link>
                <Link href="/#contact">
                  <li className="list-item-style-footer text-xl">Kontakt</li>
                </Link>
              </ul>
            ...
            <div className="w-1/3 lg:my-0 mb-[20px]">
              <p className="uppercase font-bold mb-2">Sociale</p>
              <div className="flex">
                ...
                <Link href="#">
                  <span className="w-[40px] h-[40px] text-gray-300">
                    <AiOutlineTwitter className="w-[40px] h-[40px]" />
                  </span>
                </Link>
                <Link href="#">
                  <span className="w-[40px] h-[40px] text-gray-300">
            ...
            <div className="h-10 w-1/2 lg:my-0 my-4">
              <p className="uppercase font-bold mb-2">Kontakt</p>
              <div className="flex items-center">
                <GrMail />
        ...
        <div className="flex w-full items-end justify-end text-white">
          <div className="flex items-center">
            <span className="px-2">2024 Brave Marketing Agency. All right reserved.</span>
          </div>
        </div>
      </div>
    </div>
